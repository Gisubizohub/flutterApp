...
class _AccelerometerDashboardState extends State<AccelerometerDashboard> {
  ...
  void _startMotionTimer() {
    ...
    _motionTimer = Timer(Duration(seconds: 2), () {
      ...
      _showNotification(' Hello !Your Device is in Motion');
    });
  }
  ...
  void _stopMotionTimer() {
    ...
    _motionTimer = Timer(Duration(seconds: 10), () {
      // Trigger notification for stationary state
      _showNotification(' Hello!  Your Device is not in motion');
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(' Motion Detector Dashboard'),
        backgroundColor: Color.fromARGB(255, 61, 65, 63),
      ),
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            CircularPercentIndicator(
              ...
              progressColor: Color.fromARGB(255, 58, 99, 74),
            ),
            SizedBox(height: 20),
            Row(
